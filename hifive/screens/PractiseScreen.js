    ...
    <View style={styles.container}>
      ...
      >
        ...
        <Text style={styles.prompt}>
          Take pictures of the sign language to this question one letter at a
          time! Press on the circle to shoot.
        </Text>
      ...
      <View style={styles.cameraContainer}>
        ...
        <View style={styles.shutter}>
          <Button
            icon={<FontAwesome5 name="circle" size={40} color="white" />}
            type={"clear"}
      ...
      >
        ...
        <View>
          {marking === null && counterCheck === false ? (
            <Text style={styles.markingNull}>
              {letter.length} of {qnLen} completed
            </Text>
          ) : marking === null && counterCheck === true ? (
            <Text style={styles.markingNull}>
              {letter.length} of {qnLen} completed! {"\n"}Please submit answer.
            </Text>
          ) : marking === false ? (
            <Text style={styles.markingFalse}>
              {wrong} is incorrect{"\n"}Please try again!
            </Text>
          ) : marking === true ? (
