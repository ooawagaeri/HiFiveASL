  ...
  function getQns() {
    ...
    fetch(PRACTICE_QNS_API, {
      ...
      .then((responseJson) => {
        ...
        let { answer } =
          responseJson[getRandNumber(0, responseJson.length - 1)];
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <Text style={QStyles.prompt}>
          Take pictures of the corresponding ASL to this question, 1 letter at a
          time. Press 'circle' to snap!
        </Text>
      ...
      <View style={QStyles.cameraContainer}>
        ...
        <View style={styles.shutter}>
          <Button
            icon={
              marking !== null ? (
                <FontAwesome5 name="circle" size={40} color="transparent" />
              ) : (
      ...
      >
        ...
        <View style={QStyles.bottom}>
          {marking === null ? (
            <Text style={styles.markingNull}>
              {wordLen} of {qnLen} completed
            </Text>
          ) : marking === false ? (
            <Text style={styles.markingFalse}>{wrong} is incorrect</Text>
          ) : marking === true ? (
