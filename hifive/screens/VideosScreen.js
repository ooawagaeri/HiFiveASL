      ...
      >
        <View style={{ flex: 0.6 }}>
          ...
          <Text style={styles.prompt}>
            {
              "Here are some videos to aid our ASL learning.\nScroll and click on the thumbnail to play!"
            }
          </Text>
          <FlatList
            data={DATA}
        ...
        <View style={{ flex: 0.5, alignContent: "center" }}>
          <Text style={styles.prompt2}>
            {
              "Here are some online resources for reference.\nScroll and click on the photo to be redirected to the sites!"
            }
          </Text>
          <FlatList
            data={BLOGDATA}
